...
#Creating a boolean map - Select pixels with wind speed Greater than 178km/hr
in_ras_phase1_pilot_country_clip[in_ras_phase1_pilot_country_clip > 178] <- 1
plot(in_ras_phase1_pilot_country_clip)
plot(phase1_pilot_country, add=TRUE,col =NA, lwd=0.1,border="black")
...
csv_var <- c('pop_exposed_Tropical_cyclone_178km_adm2_')

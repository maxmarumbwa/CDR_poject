...
in_raster<- raster(paste0(inpath, '/', 'Pillar1', '/','Malaria/','2010_Pv_limits_5k_Decompressed.tif'))
...
#Creating a boolean map - Select pixels with values greater than 1 per 10000 (pv stable)
in_ras_phase1_pilot_country_clip[in_ras_phase1_pilot_country_clip < 1] <- 1
plot(in_ras_phase1_pilot_country_clip)
plot(phase1_pilot_country, add=TRUE,col =NA, lwd=0.1,border="black")
...
csv_var <- c('pop_exposed_malawi_pv_unstable_')

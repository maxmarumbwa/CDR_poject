...
in_raster<- raster(paste0(inpath, '/', 'Pillar1', '/','Dengue/','dengue_2015_mean_mask.tif'))
...
#Creating a boolean map - Select pixels with values greater than 0.467
in_ras_phase1_pilot_country_clip[in_ras_phase1_pilot_country_clip > 0.467] <- 1
plot(in_ras_phase1_pilot_country_clip)
plot(phase1_pilot_country, add=TRUE,col =NA, lwd=0.1,border="black")
